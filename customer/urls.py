...
urlpatterns = [
    ...
    path('<int:pk>/status/', CustomerStatusView.as_view(), name='customer-status'),
...
urlpatterns += [
    ...
    path('credit/blacklist/', BlackListCreditListView.as_view(), name='blacklisted-list'),
    path('credit/disabled/', DisabledListView.as_view(), name='disabled-list'),
